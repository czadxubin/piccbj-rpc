...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	@Bean
	public SysUsernamePasswordAuthenticationFilter sysUsernamePasswordAuthenticationFilter() throws Exception {
		SysUsernamePasswordAuthenticationFilter filter = new SysUsernamePasswordAuthenticationFilter();
