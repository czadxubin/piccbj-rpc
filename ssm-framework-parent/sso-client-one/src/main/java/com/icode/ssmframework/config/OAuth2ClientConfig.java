...
public class OAuth2ClientConfig {
	...
	@Bean
	@Qualifier("clientCredentialsResoureceDetials")
	public OAuth2ProtectedResourceDetails clientCredentialsResoureceDetials() {
	...
	public OAuth2RestTemplate clientOAuth2RestTemplate() {
		OAuth2RestTemplate restTemplate = new OAuth2RestTemplate(clientCredentialsResoureceDetials());
	...
	public OAuth2RestTemplate ssoOAuth2RestTemplate() {
		OAuth2RestTemplate oAuth2RestTemplate = new OAuth2RestTemplate(ssoServerResourceDetails(), oauth2Context);
	...
	@Bean
	public OAuth2ProtectedResourceDetails ssoServerResourceDetails() {
